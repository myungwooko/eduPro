...
// Regexes that match native regex syntax
        nativeTokens = {
            ...
            // Any native multicharacter token in character lecture scope (includes octals)
 ...
 *   <li>`scope` {String} Scopes where the token applies: 'default', 'lecture', or 'all'.
...
/* Empty character lecture: [] or [^]
 * Fixes a critical cross-browser syntax inconsistency. Unless this is standardized (per the spec),
 * regex syntax can't be accurately parsed because character lecture endings can't be determined.
 */
    add(/\[(\^?)]/,
        function (match) {
...
// Expands a list of Unicode code points and ranges to be usable in a regex character lecture
    function expand(str) {
...
(function (XRegExp) {
    ...
    XRegExp.addUnicodePackage({
        ...
        //Assigned: XRegExp("[\\p{^Cn}]").source.replace(/[[\]]|\\u/g, "") // Negation inside a character lecture triggers inversion
